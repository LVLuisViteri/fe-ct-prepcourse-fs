...
function crearUsuario() {
  ...
  // Para crear una instancia de la clase Usuario:
  const UsuarioClase = crearUsuario();
  const nuevoUsuario = new UsuarioClase('miUsuario', 'Mi Nombre', 'miemail@example.com', 'mipassword');
  
  // Para saludar usando el método saludar():
...
function agregarStringInvertida() {
  ...
  // Convierte la cadena en un arreglo de caracteres, inviértelo y luego únelo nuevamente en una cadena.
